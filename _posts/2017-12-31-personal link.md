...
<img src="https://niniupiwofu.github.io/images/o.jpg" alt="01" style="width: 100%">
...
<img src="https://niniupiwofu.github.io/images/.jpg">

#### 第三步：找到 ```_button.scss```文件中的 ```.btn-social```属性增加 ```(github, $github-color)``` 及 ```(weibo, $weibo-color)``` 两个元素；如图：

<img src="https://niniupiwofu.github.io/images/three.jpg">
