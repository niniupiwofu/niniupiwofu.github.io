...
### 目标2：结束饥饿，实现粮食安全和改善营养，促进可持续农业
</div>
</div>
  
<div class="col-md-3">
<img src="https://unstats.un.org/sdgs/report/2017/svg/goal-02.svg" alt="SDG 2017 Report Goal 02" style="width: 100%" type="image/svg+xml">
</div>

 <div class="col-md-9" markdown="1">
目标2解决了人类对营养、健康食品的基本需求，以及为每个人可持续保障的途径。

解决饥饿问题不能单靠增加粮食生产来解决。运作良好的市场，增加对小农收入，平等的技术和土地，和额外的投资，创造一个充满活力和富有成效的农业部门建立食品安全中发挥作用。
